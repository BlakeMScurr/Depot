...
test('string <-> felt', () => {
  let cases: Array<[string, Array<number>, Array<ethers.BigNumber>]> = [
    ["", [], [ethers.BigNumber.from(0)]], // TODO: make this cause an error
    ["1", [49], [ethers.BigNumber.from(1), ethers.BigNumber.from("0x31")]],
    ["11111", [49, 49, 49, 49, 49], [ethers.BigNumber.from(1), ethers.BigNumber.from("0x3131313131")]],
    // TODO: test emojis
    ...
    [
      ...
      [ethers.BigNumber.from(1), ethers.BigNumber.from("0x31313131313131313120313131313131313131203131313131313131312031")]
    ],
    ...
    [
      ...
      [ethers.BigNumber.from(2), ethers.BigNumber.from("0x31313131313131313120313131313131313131203131313131313131312031"), ethers.BigNumber.from("0x31")]
    ],
    ...
    [
      ...
      [ethers.BigNumber.from(2), ethers.BigNumber.from("0x31313131313131313120313131313131313131203131313131313131312031"), ethers.BigNumber.from("0x31313131313131312031313131313131313120313131313131313131203131")]
    ],
    ...
    [
      ...
      [ethers.BigNumber.from(3), ethers.BigNumber.from("0x31313131313131313120313131313131313131203131313131313131312031"), ethers.BigNumber.from("0x31313131313131312031313131313131313120313131313131313131203131"), ethers.BigNumber.from("0x31")]
    ],
  ]
