import os
import pytest
from pre_proof import merkle_tree, merkle_layer
...
async def test_merkle_tree():
    ...
    merkleTree1to4 = (await contract.merkle_tree([1,2,3,4]).invoke()).result.root_hash
    ...
    merkleTree1to5 = (await contract.merkle_tree([1,2,3,4,5]).invoke()).result.root_hash
