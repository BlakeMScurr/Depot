# from https://github.com/starkware-libs/cairo-examples/blob/master/keccak/keccak.cairo
# TODO: @guthl, how do I import from places other than the common library? I only see putting it in my path, is there a package manager or something? https://www.cairo-lang.org/docs/how_cairo_works/imports.html#import-search-paths
